...
if (isset($_POST['saveShu'])) {
	...
	$data['s1105'] = $_POST['s1105'];
	$data['s1106'] = $_POST['s1106'];
	$data['s1107'] = $_POST['s1107'];
	$data['s1108'] = $_POST['s1108'];
	$data['s1109'] = $_POST['s1109'];
	...
	$data['s2011'] = $_POST['s2011'];
	$data['s2012'] = $_POST['s2012'];
	$data['s2013'] = $_POST['s2013'];
...
<?php
	...
	while ($choice = $option->fetch_assoc()) {
		if ($choice['idkoperasi'] == $recShu['idkoperasi']) {
...
?>
 ...
 <td>Pendapatan Ijarah</td>
    <td><input type="text" size="40" name="s1105" value="<?php isset($recShu['s1105']) ? $v=$recShu['s1105']: $v="0"; echo $v; ?>" class="input-text" /></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">6</td>
 <td>Pendapatan Al-Qard</td>
    <td><input type="text" size="40" name="s1106" value="<?php isset($recShu['s1106']) ? $v=$recShu['s1106']: $v="0"; echo $v; ?>" class="input-text" /></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">7</td>
 <td>Jasa Pelayanan</td>
    <td><input type="text" size="40" name="s1107" value="<?php isset($recShu['s1107']) ? $v=$recShu['s1107']: $v="0"; echo $v; ?>" class="input-text" /></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">8</td>
 <td>Pendapatan Administrasi Pembiayaan</td>
    <td><input type="text" size="40" name="s1108" value="<?php isset($recShu['s1108']) ? $v=$recShu['s1108']: $v="0"; echo $v; ?>" class="input-text" /></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">9</td>
 <td>Pendapatan Administrasi Rekening</td>
    <td><input type="text" size="40" name="s1109" value="<?php isset($recShu['s1109']) ? $v=$recShu['s1109']: $v="0"; echo $v; ?>" class="input-text" /></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 ...
 <td>Beban Jasa Pinjaman Pihak ke III</td>
    <td><input type="text" size="40" name="s2011" value="<?php isset($recShu['s2011']) ? $v=$recShu['s2011']: $v="0"; echo $v; ?>" class="input-text" /></td>
 </tr>
 <td>&nbsp;</td>
 <td align="right">23</td>
 <td>Beban Jasa Pinjaman LPDB</td>
    <td><input type="text" size="40" name="s2012" value="<?php isset($recShu['s2012']) ? $v=$recShu['s2012']: $v="0"; echo $v; ?>" class="input-text" /></td>
 </tr>
 <td>&nbsp;</td>
 <td align="right">24</td>
 <td>Beban Jasa Modal Penyertaan</td>
    <td><input type="text" size="40" name="s2013" value="<?php isset($recShu['s2013']) ? $v=$recShu['s2013']: $v="0"; echo $v; ?>" class="input-text" /></td>
 </tr>
 <tr style="background: #CCC">
 <td>&nbsp;</td>
