...
if (isset($_POST['saveShu'])) {
    ...
    $data[s1199] = $data[s1101] + $data[s1102] + $data[s1103] + $data[s1104]+$data[s1105]+$data[s1106]+$data[s1107]+$data[s1108]+$data[s1109];
	$data[s11] = $data[s1101] + $data[s1102] + $data[s1103] + $data[s1104]+$data[s1105]+$data[s1106]+$data[s1107]+$data[s1108]+$data[s1109];
	...
	$data[s2098] = $data[s2001] + $data[s2002] + $data[s2003] + $data[s2004]+$data[s2005] + $data[s2006] + $data[s2007] + $data[s2008] + $data[s2009]; 
...
?>
 ...
 <td colspan="2">A. Partisipasi Bruto Anggota:</td>
    <td><input type="text" size="40" name="s11" value="<?php isset($recShu['s11']) ? $v=$recShu['s11']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">1</td>
 <td>Pendapatan Margin Murabahah</td>
    <td><input type="text" size="40" name="s1101" value="<?php isset($recShu['s1101']) ? $v=$recShu['s1101']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">2</td>
 <td>Pendapatan Bagi Hasil Mudharabah</td>
    <td><input type="text" size="40" name="s1102" value="<?php isset($recShu['s1102']) ? $v=$recShu['s1102']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">3</td>
 <td>Pendapatan Bagi Hasil Musyarakah</td>
    <td><input type="text" size="40" name="s1103" value="<?php isset($recShu['s1103']) ? $v=$recShu['s1103']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">4</td>
 <td>Pendapatan Istishna</td>
    <td><input type="text" size="40" name="s1104" value="<?php isset($recShu['s1104']) ? $v=$recShu['s1104']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">5</td>
 <td>Pendapatan Ijarah</td>
    <td><input type="text" size="40" name="s1105" value="<?php isset($recShu['s1105']) ? $v=$recShu['s1105']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">6</td>
 <td>Pendapatan Al-Qard</td>
    <td><input type="text" size="40" name="s1106" value="<?php isset($recShu['s1106']) ? $v=$recShu['s1106']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">7</td>
 <td>Jasa Pelayanan</td>
    <td><input type="text" size="40" name="s1107" value="<?php isset($recShu['s1107']) ? $v=$recShu['s1107']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">8</td>
 <td>Pendapatan Administrasi Pembiayaan</td>
    <td><input type="text" size="40" name="s1108" value="<?php isset($recShu['s1108']) ? $v=$recShu['s1108']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">9</td>
 <td>Pendapatan Administrasi Rekening</td>
    <td><input type="text" size="40" name="s1109" value="<?php isset($recShu['s1109']) ? $v=$recShu['s1109']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td colspan="2">Jumlah Partisipasi Bruto Anggota (1+2+3..+9)</td>
 ...
 <td>Jasa Simpanan/Tabungan dari Anggota</td>
    <td><input type="text" size="40" name="s1201" value="<?php isset($recShu['s1201']) ? $v=$recShu['s1201']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">11</td>
 <td>Jasa Simpanan Berjangka dari Anggota</td>
    <td><input type="text" size="40" name="s1202" value="<?php isset($recShu['s1202']) ? $v=$recShu['s1202']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 ...
 <td>Pendapatan Margin Murabahah</td>
    <td><input type="text" size="40" name="s2001" value="<?php isset($recShu['s2001']) ? $v=$recShu['s2001']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">13</td>
 <td>Pendapatan Bagi Hasil Mudharabah</td>
    <td><input type="text" size="40" name="s2002" value="<?php isset($recShu['s2002']) ? $v=$recShu['s2002']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">14</td>
 <td>Pendapatan Bagi Hasil Musyarakah</td>
    <td><input type="text" size="40" name="s2003" value="<?php isset($recShu['s2003']) ? $v=$recShu['s2003']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">15</td>
 <td>Pendapatan Istishna</td>
    <td><input type="text" size="40" name="s2004" value="<?php isset($recShu['s2004']) ? $v=$recShu['s2004']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">16</td>
 <td>Pendapatan Ijarah</td>
    <td><input type="text" size="40" name="s2005" value="<?php isset($recShu['s2005']) ? $v=$recShu['s2005']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">17</td>
 <td>Pendapatan Al-Qard</td>
    <td><input type="text" size="40" name="s2006" value="<?php isset($recShu['s2006']) ? $v=$recShu['s2006']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">18</td>
 <td>Jasa Pelayanan Non Anggota</td>
    <td><input type="text" size="40" name="s2007" value="<?php isset($recShu['s2007']) ? $v=$recShu['s2007']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">19</td>
 <td>Pendapatan Administrasi Pembiayaan</td>
    <td><input type="text" size="40" name="s2008" value="<?php isset($recShu['s2008']) ? $v=$recShu['s2008']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">20</td>
 <td>Pendapatan Administrasi Rekening</td>
    <td><input type="text" size="40" name="s2009" value="<?php isset($recShu['s2009']) ? $v=$recShu['s2009']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr style="background: #CCC">
 <td>&nbsp;</td>
 ...
 <td>Beban Jasa Hutang Bank</td>
    <td><input type="text" size="40" name="s2010" value="<?php isset($recShu['s2010']) ? $v=$recShu['s2010']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <td>&nbsp;</td>
 <td align="right">22</td>
 <td>Beban Jasa Pinjaman Pihak ke III</td>
    <td><input type="text" size="40" name="s2011" value="<?php isset($recShu['s2011']) ? $v=$recShu['s2011']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <td>&nbsp;</td>
 <td align="right">23</td>
 <td>Beban Jasa Pinjaman LPDB</td>
    <td><input type="text" size="40" name="s2012" value="<?php isset($recShu['s2012']) ? $v=$recShu['s2012']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <td>&nbsp;</td>
 <td align="right">24</td>
 <td>Beban Jasa Modal Penyertaan</td>
    <td><input type="text" size="40" name="s2013" value="<?php isset($recShu['s2013']) ? $v=$recShu['s2013']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr style="background: #CCC">
 <td>&nbsp;</td>
 ...
 <tr>
 <td>&nbsp;</td>
 <td colspan="2">Laba Rugi Kotor dengan Non Anggota (12+13+...+24)</td>
 ...
 <td>Beban Gaji dan Honor</td>
    <td><input type="text" size="40" name="s3101" value="<?php isset($recShu['s3101']) ? $v=$recShu['s3101']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">26</td>
 <td>Beban Lembur</td>
    <td><input type="text" size="40" name="s3102" value="<?php isset($recShu['s3102']) ? $v=$recShu['s3102']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">27</td>
 <td>Beban THR</td>
    <td><input type="text" size="40" name="s3103" value="<?php isset($recShu['s3103']) ? $v=$recShu['s3103']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">28</td>
 <td>Beban Perjalanan dalam rangka operasional Simpan  Pinjam</td>
    <td><input type="text" size="40" name="s3104" value="<?php isset($recShu['s3104']) ? $v=$recShu['s3104']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">29</td>
 <td>Beban Fotocopy dan ATK</td>
    <td><input type="text" size="40" name="s3105" value="<?php isset($recShu['s3105']) ? $v=$recShu['s3105']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">30</td>
 <td>Beban Listrik / PAM</td>
    <td><input type="text" size="40" name="s3106" value="<?php isset($recShu['s3106']) ? $v=$recShu['s3106']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">31</td>
 <td>Beban Telepon</td>
    <td><input type="text" size="40" name="s3107" value="<?php isset($recShu['s3107']) ? $v=$recShu['s3107']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">32</td>
 <td>Beban Administrasi dan Umum</td>
    <td><input type="text" size="40" name="s3108" value="<?php isset($recShu['s3108']) ? $v=$recShu['s3108']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">33</td>
 <td>Beban Rapat - rapat Komite Pinjaman</td>
    <td><input type="text" size="40" name="s3109" value="<?php isset($recShu['s3109']) ? $v=$recShu['s3109']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">34</td>
 <td>Beban Pemasaran</td>
    <td><input type="text" size="40" name="s3110" value="<?php isset($recShu['s3110']) ? $v=$recShu['s3110']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">35</td>
 <td>Beban Sewa tahun berjalan</td>
    <td><input type="text" size="40" name="s3111" value="<?php isset($recShu['s3111']) ? $v=$recShu['s3111']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">36</td>
 <td>Beban Pemeliharaan Aktiva tetap dan peralatan kantor</td>
    <td><input type="text" size="40" name="s3112" value="<?php isset($recShu['s3112']) ? $v=$recShu['s3112']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">37</td>
 <td>Beban Penyusutan Aktiva Tetap</td>
    <td><input type="text" size="40" name="s3113" value="<?php isset($recShu['s3113']) ? $v=$recShu['s3113']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">38</td>
 <td>Beban Penyisihan Penghapusan Piutang</td>
    <td><input type="text" size="40" name="s3114" value="<?php isset($recShu['s3114']) ? $v=$recShu['s3114']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">39</td>
 <td>Beban Pendidikan dan latihan Karyawan</td>
    <td><input type="text" size="40" name="s3115" value="<?php isset($recShu['s3115']) ? $v=$recShu['s3115']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">40</td>
 <td>Beban Operasional lain dalam rangka operasional Simpan Pinjam</td>
    <td><input type="text" size="40" name="s3116" value="<?php isset($recShu['s3116']) ? $v=$recShu['s3116']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td colspan="2">Jumlah Beban Usaha (25+265+.....+40)</td>
 ...
 <td>Beban Pengawas dan pengurus koperasi</td>
    <td><input type="text" size="40" name="s3201" value="<?php isset($recShu['s3201']) ? $v=$recShu['s3201']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">42</td>
 <td>Beban Pembinaan, Pendidikan dan Pelatihan perkoperasian</td>
    <td><input type="text" size="40" name="s3202" value="<?php isset($recShu['s3202']) ? $v=$recShu['s3202']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">43</td>
 <td>Beban RAT</td>
    <td><input type="text" size="40" name="s3203" value="<?php isset($recShu['s3203']) ? $v=$recShu['s3203']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr >
 <td>&nbsp;</td>
 <td>44</td><td>Beban Perkoperasian Lain</td>
    <td><input type="text" size="40" name="s3298" value="<?php isset($recShu['s3298']) ? $v=$recShu['s3298']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr style="background: #CCC">
 <td>&nbsp;</td>
 <td colspan="2">Jumlah Beban Perkoperasian</td>
    <td><input type="text" size="40" name="s3299" value="<?php isset($recShu['s3299']) ? $v=$recShu['s3299']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td></td>
 ...
 <td>Pendapatan Lain - lain</td>
    <td><input type="text" size="40" name="s3301" value="<?php isset($recShu['s3301']) ? $v=$recShu['s3301']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">46</td>
 <td>Beban Lain - lain</td>
    <td><input type="text" size="40" name="s3302" value="<?php isset($recShu['s3302']) ? $v=$recShu['s3302']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 ...
 <td colspan="2">F. Pajak Penghasilan Badan</td>
    <td><input type="text" size="40" name="s34" value="<?php isset($recShu['s34']) ? $v=$recShu['s34']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td>&nbsp;</td>
 <td>SISA HASIL USAHA SETELAH PAJAK</td>
    <td><input type="text" size="40" name="s95" value="<?php isset($recShu['s95']) ? $v=$recShu['s95']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
					<tr>
