...
if (isset($_POST['saveShu'])) {
    ...
    // Cek existing data
    $query_text = "SELECT * from shu WHERE idkoperasi = " . $data['idkoperasi'] . " AND " . "dateposting = '". $data['dateposting'] ."' AND tahunan = ". $data['tahunan'] ;
...
?>
 ...
 <td colspan="2">A. Partisipasi Bruto Anggota:</td>
    <td><input type="text" size="40" name="shu[s11]" value="<?php isset($recShu['s11']) ? $v=$recShu['s11']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">1</td>
 ...
 <td>Pendapatan Ijarah</td>
    <td><input type="text" size="40" name="shu[s1105]" value="<?php isset($recShu['s1105']) ? $v=$recShu['s1105']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">6</td>
 <td>Pendapatan Al-Qard</td>
    <td><input type="text" size="40" name="shu[s1106]" value="<?php isset($recShu['s1106']) ? $v=$recShu['s1106']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">7</td>
 <td>Jasa Pelayanan</td>
    <td><input type="text" size="40" name="shu[s1107]" value="<?php isset($recShu['s1107']) ? $v=$recShu['s1107']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">8</td>
 <td>Pendapatan Administrasi Pembiayaan</td>
    <td><input type="text" size="40" name="shu[s1108]" value="<?php isset($recShu['s1108']) ? $v=$recShu['s1108']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">9</td>
 <td>Pendapatan Administrasi Rekening</td>
    <td><input type="text" size="40" name="shu[s1109]" value="<?php isset($recShu['s1109']) ? $v=$recShu['s1109']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 ...
 <td>Beban Jasa Pinjaman Pihak ke III</td>
    <td><input type="text" size="40" name="shu[s2011]" value="<?php isset($recShu['s2011']) ? $v=$recShu['s2011']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <td>&nbsp;</td>
 <td align="right">23</td>
 <td>Beban Jasa Pinjaman LPDB</td>
    <td><input type="text" size="40" name="shu[s2012]" value="<?php isset($recShu['s2012']) ? $v=$recShu['s2012']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <td>&nbsp;</td>
 <td align="right">24</td>
 <td>Beban Jasa Modal Penyertaan</td>
    <td><input type="text" size="40" name="shu[s2013]" value="<?php isset($recShu['s2013']) ? $v=$recShu['s2013']: $v="0"; echo number_format($v,2,',','.').$disabled; ?></td>
 </tr>
 <tr style="background: #CCC">
 <td>&nbsp;</td>
