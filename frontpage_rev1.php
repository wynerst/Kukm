...
$datagrid->table_attr = 'align="right" id="dataList" cellpadding="5" cellspacing="0"';
...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<div id="slider">
				<ul>
					<li><img src="simpleplot3.php" width="500px"></li>
					<li><img src="simpleplot4.php" width="500px"></li>
					<li><img src="tmp/barchart.png" height="250px"></li>
				</ul>
			</div>
