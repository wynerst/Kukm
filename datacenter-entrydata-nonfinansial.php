...
?>
		...
		<div id="content" class="box">
			...
			<?php
			if (isset($_GET['list'])) {
				echo "<fieldset>\n<legend>Data Pendukung Tersedia</legend>";
				echo listNonNeraca();
				echo '<form action="datacenter-entrydata-nonfinanSial.php" method="link"><table class="nostyle">';
...
<?php
	...
	while ($choice = $option->fetch_assoc()) {
		if ($choice['idkoperasi'] == $recNon['idkoperasi']) {
