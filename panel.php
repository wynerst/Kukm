...
?>
		...
		<div id="content" class="box">
			...
			<!-- Headings -->
			<h2>Daftar Lembaga Baru</h2>
			<p>Daftarkan lembaga peserta baru.</p>
			<h2>Tambah User Baru</h2>
			<p>Daftarkan user baru yang mengatur data dari lembaga yang diwakilkan.</p>
			<h2>Buat Grup Baru</h2>
			<p>Buat grup baru untuk untuk pengelompokan lembaga.</p>
			<h2>Daftar Lembaga</h2>
			<p>Tampilkan daftar lembaga peserta. Anda juga bisa mengedit dan menghapus data yang sudah ada.</p>
			<h2>Daftar User</h2>
			<p>Tampikan daftar user. Anda juga bisa mengedit dan menghapus data yang sudah ada.</p>
			<h2>Daftar Grup</h2>
			<p>Tampikan daftar group. Anda juga bisa mengedit dan menghapus data yang sudah ada.</p>
