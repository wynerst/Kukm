...
$datagrid->setSQLorder('k.propinsi ASC, YEAR(h.periode)');
$datagrid->setSQLcriteria('YEAR(h.periode) < YEAR(curdate()) AND YEAR(h.periode) > YEAR(curdate())-6');
$datagrid->sql_group_by = 'k.propinsi, YEAR(h.periode)';
...
$frontpage_content = '<h3>Laporan Tahunan Berdasar Propinsi&nbsp;<a href="keterangan.php" target="blank" title="Penjelasan tabel"><img src="images/info.png" /></a></h3><p>';
